...
from lib.models.model import PredNet
...
def setup_loaders(args):
    train_set = DDD20Dataset(split='train', group_size=args.group_size)
    test_set = DDD20Dataset(split='test', group_size=args.group_size)
...
def setup_model(args):
    if args.use_temp:
        ...
        temp = None
    model = PredNet(use_radians=bool(args.use_radians),
